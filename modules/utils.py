...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.discriminator = nn.Sequential(
            nn.Linear(in_features=256 * 16 * 16, out_features=100),
            # with img 512*512 put 512*32*32, with 256 512*16*16
            nn.ReLU(),
...
def spatiotemporal_batches(img_names,
    ...
    cat = {'D004_2021': 0, 'D058_2020': 1, 'D070_2020': 2, 'D078_2021': 3, 'D016_2020': 4, 'D013_2020': 5,
           'D072_2019': 6, 'D067_2021': 7, 'D021_2020': 8, 'D080_2021': 9,
           'D033_2021': 10, 'D074_2020': 11, 'D091_2021': 12, 'D017_2018': 13, 'D044_2020': 14, 'D006_2020': 15,
           'D066_2021': 16, 'D046_2019': 17, 'D051_2019': 18, 'D052_2019': 19,
           'D060_2021': 20, 'D077_2021': 21, 'D041_2021': 22, 'D030_2021': 23, 'D031_2019': 24, 'D014_2020': 25,
           'D081_2020': 26, 'D023_2020': 27, 'D009_2019': 28, 'D008_2019': 29,
           'D007_2020': 30, 'D032_2019': 31, 'D086_2020': 32, 'D035_2020': 33, 'D029_2021': 34, 'D034_2021': 35,
           'D063_2019': 36, 'D055_2018': 37, 'D038_2021': 38, 'D049_2020': 39,
           'D075_2021': 40, 'D026_2020': 41, 'D064_2021': 42, 'D022_2021': 43, 'D071_2020': 44, 'D085_2019': 45,
           'D012_2019': 46, 'D076_2019': 47, 'D083_2020': 48, 'D068_2021': 49}
    ...
    # distr label domains
    lab_distr_d = {"D064_2021": [0.0003647796201034331, 0.06452758359237457, 0.06800279214348591, 0.14679691368425396,
                                 0.18834572805485256,
                                 0.09078354311660981, 0.01652554364271567, 0.12179119271291813, 0.08433024661641725,
                                 0.0061088110695422535,
                                 0.18021248401050835, 0.01684239562128631, 0.015367986114931778],
                   "D068_2021": [0.004719607930787852, 0.06526496135013204, 0.07535856864821742, 0.12260942485970511,
                                 0.007733042542363557,
                                 0.057821044921875, 0.006844044000330105, 0.19354975310849473, 0.035361164791483275,
                                 0.06611181124834947,
                                 0.2357878263231734, 0.09719313070807659, 0.031645619567011445],
                   "D071_2020": [0.0017459106445312498, 0.05118809170193142, 0.05566404554578993, 0.10303836398654515,
                                 0.0003597598605685764,
                                 0.02859917534722222, 0.00203826904296875, 0.1325440385606554, 0.032226003011067705,
                                 0.09877537197536893,
                                 0.35038882785373265, 0.1280748070610894, 0.015357335408528646],
                   "D006_2020": [0.03492800215600242, 0.12720996050767497, 0.0802984404228103, 0.19650017751774318,
                                 0.13191305885852223,
                                 0.0366021728515625, 0.059666593309859156, 0.10551761466012874, 0.09073230797136334,
                                 0.003184088048800616,
                                 0.10934297803422095, 0.018314939686949822, 0.0057896659743617955],
                   "D008_2019": [0.007713683222381163, 0.09044400067396567, 0.07191997689260564, 0.13460382166043133,
                                 0.0002639125770246479,
                   ...
                   "D013_2020": [0.00011058862658514493, 0.05202315620754076, 0.16280777640964675, 0.14575036974920744,
                                 0.0928029732082201,
                                 0.09952922434046649, 0.0491379005321558, 0.058422267747961956, 0.19792177062103714,
                                 0.02897713923799819,
                                 0.08007818691972374, 0.013082390384397645, 0.019356256015058877],
                   "D017_2018": [0.000976715087890625, 0.10267012702094185, 0.0804528554280599, 0.15790524800618488,
                                 0.03490570068359375,
                                 0.12083129035101997, 0.013971896701388889, 0.10339057922363282, 0.081606691148546,
                                 0.043872511121961805,
                                 0.19314151340060765, 0.06627487182617188, 0],
                   "D023_2020": [0.0003672281901041667, 0.01062700907389323, 0.037166239420572914, 0.038042399088541665,
                                 4.887898763020833e-05,
                   ...
                   "D029_2021": [0.004756734636094835, 0.08399313184950087, 0.04870170593261719, 0.17258464813232421,
                                 0.028876094818115233,
                                 0.10229706658257379, 0.026563387976752388, 0.10788974126180013, 0.06514180077446832,
                                 0.0004709879557291667,
                                 0.20942507637871635, 0.09209336174858941, 0.0572062619527181],
                   "D033_2021": [0.0012820993342869719, 0.08024832712092869, 0.1257984687912632, 0.1593204637984155,
                                 0.057976908079335386,
                                 0.05922734650088028, 0.02655764297700264, 0.08596138107944543, 0.07612547968474911,
                                 0.1250477793518926,
                                 0.1290090899400308, 0.037058784592319545, 0.03638622874944982],
                   "D058_2020": [0.0023912556966145834, 0.03721769544813368, 0.061170247395833335, 0.0755106692843967,
                                 0.014330079820421006,
                                 0.04607422722710503, 0.008577635023328993, 0.16849986606174044, 0.04217371622721354,
                                 0.03822308858235677,
                                 0.15391856723361544, 0.3192870076497396, 0.03262594434950087],
                   "D067_2021": [0.002779558706974638, 0.14089519113734147, 0.0812784034618433, 0.2273738076030344,
                                 3.6541482676630437e-05,
                                 0.0510047802026721, 0.011937547766644022, 0.1469181403560915, 0.012665069137794385,
                                 0.07098500127377717,
                                 0.15250635119451994, 0.03385585619055707, 0.06776375148607337],
                   "D074_2020": [0.006011663698682598, 0.06745630600873162, 0.047696437461703434, 0.11564254461550245,
                                 0.07988143621706495,
                                 0.08252154181985294, 0.07511855181525735, 0.17171317306219364, 0.018746589211856617,
                                 0.001415118049172794,
    ...
    return torch.stack(coord_batch).cuda(), torch.stack(month_batch).cuda(), torch.stack(
        hour_batch).cuda(), torch.stack(year_batch).cuda(), torch.stack(domain_batch).cuda(), torch.stack(
