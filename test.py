...
###########  GET OTHER DATA ##############
geo_data = get_geo_data(os.path.join(exp_config['data']['path'], "DATASET_DEF1_METADATA_train.json"),
                        os.path.join(exp_config['data']['path'], "DATASET_DEF1_METADATA_test.json"))
